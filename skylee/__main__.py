...
Any issues or need help related to me? join our group [Group Chat](https://t.me/friendszonexd).

Wanna Add me to your Group? Just click the button below Now!
"""

buttons = [
    [
        InlineKeyboardButton(
            text="Add to Group", url="t.me/OfflineSecurityBot?startgroup=true"
        ),
        InlineKeyboardButton(
            text="Group", url="t.me/friendszonexd?startgroup=true"
        ),
        InlineKeyboardButton(text="Channel 📢", url="https://t.me/MyNetworkZero"),
    ]
]
